...
public class FindthemaximumGCDofthesiblingsofaBinaryTree {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t > 0) {
            ...
            FindthemaximumGCDofthesiblingsofaBinaryTree_exe ob = new FindthemaximumGCDofthesiblingsofaBinaryTree_exe();
...
class FindthemaximumGCDofthesiblingsofaBinaryTree_exe {
